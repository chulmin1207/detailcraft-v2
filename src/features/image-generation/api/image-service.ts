...
스펙 수치: 볼드 + 악센트 컬러
단위: 라이트체로 수치 옆에`,
    graphicElements: `성분 표시 그래픽 (원형 차트, 진행 바)
깔끔한 구분선 또는 점선
추상적 아이콘 (구체적 인증마크/로고 금지)`,
...
전체적으로 신뢰감 주는 깔끔한 레이아웃`,
    typography: `핵심 키워드: 48pt+ 초대형 볼드 (악센트 컬러)
보조 텍스트: 14pt`,
    graphicElements: `별점 ★★★★★ 그래픽
신뢰 관련 추상 아이콘 (방패, 체크마크, 하트)
⚠️ 실제 인증마크(HACCP, ISO, 식약처 등)를 절대 생성하지 마세요
⚠️ 구체적 수치(만족도 98%, 판매량 12만 등)를 임의로 생성하지 마세요
⚠️ 실존 기관 로고나 수상 배지를 만들어내지 마세요`,
    productPlacement: '제품 패키지를 깔끔하게 배치',
  },
  8: {

...
export function ChecklistSection() {
  ...
  const handleRunChecklist = useCallback(async () => {
    ...
    try {
      ...
      console.error('[ChecklistSection] 품질 체크 분석 실패:', error);
      ...
      <div className="p-6">
        {!result && (
          <div className="text-center py-8 text-text-tertiary">
            <p className="text-lg mb-2">AI 품질 검증</p>
            <p className="text-sm mb-4">생성된 이미지의 텍스트 가독성, 디자인 품질, 제품 배치 등을 자동 분석합니다.</p>
            <ul className="text-xs text-left max-w-sm mx-auto space-y-1">
              <li>- 텍스트 가독성 및 오탈자 확인</li>
              <li>- 제품 이미지 배치 적절성</li>
              <li>- 디자인 일관성 및 품질</li>
              <li>- 플랫폼 규격 준수 여부</li>
            </ul>

...
// We import from the download feature's API
// Note: downloadAllImages should be available from the download service
...
export function DownloadSection() {
  ...
  const handleDownload = useCallback(async () => {
    ...
    try {
      ...
      const { downloadAllImages } = await import('@/features/download/api/download-service');
